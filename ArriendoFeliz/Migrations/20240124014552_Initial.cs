        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ModeloId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombreModelo = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Arriendos_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Arriendos_Marcas_MarcaId",
                        column: x => x.MarcaId,
                        principalTable: "Marcas",
                        principalColumn: "MarcaId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Arriendos_Modelos_ModeloId",
                        column: x => x.ModeloId,
            ...
            migrationBuilder.InsertData(
                table: "Modelos",
                columns: new[] { "ModeloId", "NombreModelo" },
                values: new object[,]
                {
                    { 1, "Logan" },
                    { 2, "A4" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Arriendos_ClienteId",
                table: "Arriendos",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_Arriendos_MarcaId",
                table: "Arriendos",
                column: "MarcaId");

            migrationBuilder.CreateIndex(
                name: "IX_Arriendos_ModeloId",
                table: "Arriendos",
                column: "ModeloId");

            migrationBuilder.CreateIndex(
                name: "IX_Arriendos_Patente",
                table: "Arriendos",
                column: "Patente",
                unique: true,
